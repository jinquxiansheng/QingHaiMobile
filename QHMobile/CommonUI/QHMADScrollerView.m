...
@implementation QHMADScrollerView
@synthesize delegate;
...
-(id)initWithFrameRect:(CGRect)rect ImageArray:(NSArray *)imgArr TitleArray:(NSArray *)titArr
{
	...
	if ((self=[super initWithFrame:rect])) {
       ...
       // pageControl=[[UIPageControl alloc]initWithFrame:CGRectMake((self.frame.size.width-pageControlWidth),6, pageControlWidth, pagecontrolHeight)];
        ...
        [pageControl addWHConstraintsWithSuperView:noteView width:pageControlWidth height:pagecontrolHeight];
        [pageControl addPaddingConstraintsWithSuperView:noteView top:6 bottom:CGFLOAT_CONSTRAINTS_INVALID left:CGFLOAT_CONSTRAINTS_INVALID right:CGFLOAT_CONSTRAINTS_INVALID];
        [pageControl setEdge:noteView attr:NSLayoutAttributeCenterX constant:0];
